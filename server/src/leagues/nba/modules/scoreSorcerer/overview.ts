...
import { NBA_SCORE_SORCERER_LABEL, NBA_SCORE_SORCERER_NO_MORE_SCORES } from './constants';

export const nbaScoreSorcererOverview: ModeOverview = {
  key: 'nba_score_sorcerer',
  ...
  participantChoices: ['pass', 'Home Team', 'Away Team', NBA_SCORE_SORCERER_NO_MORE_SCORES],
  winningCondition:
