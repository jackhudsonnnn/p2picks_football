import { STAT_KEY_LABELS as EITHER_OR_STAT_KEY_LABELS, STAT_KEY_TO_CATEGORY as EITHER_OR_STAT_KEY_TO_CATEGORY } from '../eitherOr/constants';

export const KING_OF_THE_HILL_STAT_KEY_TO_CATEGORY = EITHER_OR_STAT_KEY_TO_CATEGORY;
export const KING_OF_THE_HILL_STAT_KEY_LABELS = EITHER_OR_STAT_KEY_LABELS;

export const KING_OF_THE_HILL_MIN_RESOLVE_VALUE = 0;
