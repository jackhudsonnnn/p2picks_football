...
export const RESOLUTION_QUEUE_CONCURRENCY = process.env.RESOLUTION_QUEUE_CONCURRENCY || '';
export const USE_RESOLUTION_QUEUE = process.env.USE_RESOLUTION_QUEUE || 'true';

// nfl data
export const NFL_DATA_RAW_INTERVAL_SECONDS = Math.max(12, Number(process.env.NFL_DATA_RAW_INTERVAL_SECONDS) || 20);
...
export const NFL_DATA_REFINED_INTERVAL_SECONDS = Math.max(12, Number(process.env.NFL_DATA_REFINED_INTERVAL_SECONDS) || 20);
