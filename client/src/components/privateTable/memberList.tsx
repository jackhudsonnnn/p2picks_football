  ...
  <section className="members-container" aria-label="Table members">
    <div className="members-list">
      ...
      {members.map((member, idx) => (
        <div
          key={member.userId}
          className={`member-row${idx % 2 === 1 ? " member-row-alt" : ""}`}
        >
              ...
              {member.userId === hostUserId && (
                <span className="host-badge" title="Host" aria-label="Host">
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M8 2l1.76 3.57L14 6.18l-2.5 2.44.59 3.44L8 10.77l-3.09 1.29.59-3.44L3 6.18l4.24-.61z"
                    />
                  </svg>
                </span>
              )}
              {member.userId === currentUserId && (
                <span className="you-badge" title="You" aria-label="You">
                  ...
                  >
                    ...
                    <path
                      fill="currentColor"
                      d="M2 14c0-2.21 2.91-4 6-4s6 1.79 6 4"
                    />
                  </svg>
                </span>
              )}
          ...
          <span
            className={`member-balance${
              Number(member.balance) < 0 ? " negative" : " positive"
            }`}
            title={`${member.balance} pts`}
          >
